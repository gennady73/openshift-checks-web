...
occode.storage = {
    set: function (key, value) {
        if (window.localStorage) {
            ...
            occode.config.set('__storage_'+key, value);
        }
    },
    get: function (key) {
        if (window.localStorage) {
            ...
            return occode.config.get('__storage_'+key, null);
        }
    },
    remove: function (key) {
        if (window.localStorage) {
            ...
            occode.config.remove('__storage_'+key);
        }
    },
    clear: function () {
        if (window.localStorage) {
            ...
            occode.config.clear('__storage_');
        }
    },
};

/* truncate string from left */
occode.strTruncateLeft = function (string, max_length, replacement) {
    string = '' + string;
